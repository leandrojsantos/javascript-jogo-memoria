/**
 * A condicional switch avalia uma expressão, combinando o valor da expressão para um case ou caso, e executa as instruções  associadas ao case.
 */
...
//desse modo n eh necesario ficar replicado cod 
terminal.question(
...
function menuInicial(msg) {
    ...
    if(isNaN(resposta)){
        throw new Error('Não e uma op, tente novamente!!!',msg)
    }
    switch (resposta) {
        case 0:
            console.log('Saindo...')
